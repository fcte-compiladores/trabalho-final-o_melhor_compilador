OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/token.o ./build/lex_process.o ./build/parser.o \
./build/node.o ./build/scope.o ./build/symresolver.o ./build/helpers/buffer.o ./build/helpers/vector.o ./build/expressionable.o
